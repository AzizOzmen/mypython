...
# 💡Objective:
# To improve your control flow statement 
# and arithmetic operator algorithm skills.
# Write your Python codes on any IDE 
# and push it up to your GitHub repository, 
# then submit your GitHub page address link 
# in addition to your codes (answer) as a plain text. 
...
# According to these rules, the years 2000 
...
# "2020 is a leap year" if the given year by the user is a leap year, 
